...
<div class="flex items-center justify-between">
    <h1 class="text-3xl text-black pb-6">Form Edit Category</h1>
</div>
    ...
    <form action="{{route('category.update', $category->id_category)}}" method="POST">
        ...
        <div class="grid grid-cols-1 gap-6">
            ...
            <div class="mb-2">
                ...
                <input type="namacategory" id="namacategory" name="namacategory" value="{{$category->namacategory}}" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Masukan Nama Category" required />
            </div>

            <div class="mb-2">
                <label for="harga" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Harga Category</label>
                <input type="name" id="harga" name="harga" value="{{$category->harga}}" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Masukan Harga Category" required />
            </div>

            <div class="mb-2">
                <label for="deskripsi" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Deskripsi Category</label>
                <textarea id="deskripsi" name="deskripsi" rows="4" class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Masukan Deskripsi Category">{{$category->deskripsi}}</textarea>
            </div>
