    ...
    <section id="services" class="bg-white h-full px-6">
        <div class="max-w-screen-xl py-24 flex flex-col items-center justify-around mx-auto">
            ...
            <div class="grid grid-cols-2 md:grid-cols-3 items-center gap-4 mb-12">
                ...
                <div class="content">
                    <img src="/assets/images/paket/{{$pack->image}}" alt="{{$pack->namapaket}}" class="w-full rounded shadow-lg transition-transform duration-300 ease-in-out transform hover:scale-105">
                </div>
                @endforeach
            </div>
            <a href="{{url('userbooking')}}">
        ...
        <div class="max-w-screen-xl py-24 flex flex-col items-center justify-around mx-auto">
            ...
            <div class="flex flex-col md:flex-row gap-8 w-full justify-center mt-8">
                <div class="bg-white flex flex-col justify-around px-6 py-8 w-full h-full rounded-xl shadow-md">
                    ...
                    <form action="{{route('kritiksaran.store')}}" method="POST" class="flex flex-col gap-6 my-6">
                        @csrf
                        <div>
                        ...
                        <div>
                            <label for="pesan" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Your message</label>
                            <textarea id="pesan" rows="4" name="pesan" class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Message..."></textarea>
                        </div>
